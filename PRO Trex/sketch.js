...
var snack1Sprite, snack2Sprite, snack3Sprite, snack4Sprite, snack5Sprite, snack6Sprite;
var cloudImg, tRexRunningImg, tRexCollideImg, tRexCollideImg, obstacle1Img,obstacle2Img,obstacle3Img,obstacle4Img,obstacle5Img, enemyImg, craneoImg,

obstacle6Img, gameOverImg, restartImg;                                  //Imágenes
var red, green, blue, score=0;                                          //Variables distintas
...
function draw(){                                                
  ...
  text("Score: " + score, 490,70);                              //Mostrar texto para la puntuación del marcador
  ...
  if(gameState === "PLAY"){
    ...
    if(enemiesGroup.isTouching(tRexSprite)){                    //Si los enemigos tocan al tRex
      score -= 3;                                              //Resta puntos al score
      dieSound.play();
